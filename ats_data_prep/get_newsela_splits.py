...
Example call:
    ...
    python get_newsela_splits.py /srv/scratch6/kew/ats/data/en/newsela_article_corpus_2016-01-29/articles_metadata.csv
"""
...
if __name__ == '__main__':
    ...
    update_meta_data(meta_data, 'en')
    update_meta_data(meta_data, 'es')
