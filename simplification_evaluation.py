...
Example call:
    ...
    python simplification_evaluation.py \
        --src_file resources/data/en/aligned/newsela_manual_v0_v4_test.tsv \
        --hyp_file resources/muss/outputs/newsela_manual_v0_v4_test_lr0.47_ls0.79_wr0.43_td0.42.pred \
        --compute_ppl
